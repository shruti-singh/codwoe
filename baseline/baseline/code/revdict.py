...
def pred(args):
    ...
    model = models.DefmodModel.load(args.save_dir / args.target_arch / "model.pt")
    train_vocab = data.JSONDataset.load(args.save_dir / args.target_arch / "train_dataset.pt").vocab
